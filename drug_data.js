...
autonomic: [
{
    ...
    drugs: [
      ...
      },
      {
        ...
        tags: ["Myasthenia", "Alzheimer's", "Reversal"],
      ...
      },
      {
        ...
        tags: ["Asthma/COPD", "Motion Sickness", "Parkinson's"],
  ...
  },
{
    ...
    drugs: [
      ...
      },
      {
        ...
        use: "Hydralazine: HTN in pregnancy (safe; DOC for eclampsia), HF in African Americans (+ nitrate, BiDil). Minoxidil: severe refractory HTN, topical for alopecia. Nitroprusside: hypertensive emergency (IV), acute HF",
  ...
  },
{
    ...
    drugs: [
      ...
      },
      {
        ...
        summary: "Class V antiarrhythmic — DOC for torsades de pointes and eclampsia/pre-eclampsia. Mechanism: Ca²⁺ channel antagonism + membrane stabilization",
        tier: 1,
        aka: "MgSO₄",
    ...
    drugs: [
      {
        ...
        tags: ["DVT/PE", "ACS", "Pregnancy-safe"],
      ...
      },
      {
        ...
        tier: 1,
        aka: "Coumadin",
        tags: ["AF", "DVT/PE", "Prosthetic Valves"],
  ...
  },
  {
    ...
    drugs: [
      ...
      },
      {
        ...
        tags: ["Claudication", "Stroke Prevention", "Vasodilation"],
  ...
  },
{
    ...
    drugs: [
      ...
      },
      {
        ...
        tags: ["Atypical Depression", "Parkinson's"],
  ...
  },
{
    ...
    drugs: [
      ...
      {
        name: "Carbamazepine",
        summary: "Na+ channel blocker — focal seizures + trigeminal neuralgia (DOC) + bipolar. SE: aplastic anemia, SIADH, SJS (HLA-B*1502 in Asians)",
        tier: 1,
    ...
    drugs: [
      {
        ...
        summary: "Pen G: DOC for syphilis (all stages), Group A Streptococcus, Neisseria meningitidis. Benzathine PCN G: neurosyphilis requires IV Pen G",
        tier: 1,
        ...
        moa: "Bind **penicillin-binding proteins (PBPs)** → inhibit transpeptidation of peptidoglycan cross-links → cell wall lysis; beta-lactam ring essential for activity",
      ...
      },
      {
        ...
        summary: "Nafcillin/oxacillin: narrow spectrum for MSSA only. DOC for MSSA (superior to vancomycin). Nafcillin causes neutropenia and is hepatically cleared",
        tier: 1,
        ...
        pk: "Nafcillin: hepatically cleared (safe in renal failure unlike most beta-lactams). Oxacillin: biliary/hepatic clearance. Dicloxacillin: oral formulation",
      ...
      },
      {
        ...
        tags: ["Gram-Positive", "Gram-Negative", "Listeria", "Enterococcus", "H. pylori", "UTI"],
      ...
      },
      {
        ...
        tags: ["Gram-Positive", "Gram-Negative", "Pseudomonas", "Anaerobes", "Nosocomial"],
    ...
    drugs: [
      {
        ...
        use: "Severe **Gram-negative aerobic infections**. Tobramycin: Pseudomonas aeruginosa. Gentamicin: synergistic coverage for endocarditis with beta-lactams. Streptomycin: Tuberculosis, plague. Neomycin: oral bowel prep",
      ...
      },
      {
        ...
        tags: ["Atypicals", "Chlamydia", "Lyme", "Tick-borne", "Mycoplasma"],
      ...
      },
      {
        ...
        tags: ["Gram-Positive", "Atypicals", "Pneumonia", "Chlamydia", "Pertussis", "H. pylori"],
      ...
      },
      {
        ...
        pearl: "**Toxin suppression mechanism:** In necrotizing fasciitis, a beta-lactam is used to kill the bacteria, while clindamycin is specifically added to shut down the 50S ribosome and halt the synthesis of tissue-destroying exotoxins."
      },
      {
    ...
    drugs: [
      {
        ...
        tags: ["Gram-Negative", "UTI", "Pneumonia", "Pseudomonas", "Atypicals"],
      ...
      },
      {
        ...
        tier: 1,
        aka: "Flagyl",
        tags: ["Anaerobes", "C. difficile", "Protozoa", "Bacterial Vaginosis"],
      ...
      },
      {
        ...
        tier: 1,
        aka: "Bactrim, Septra",
        tags: ["Gram-Negative", "MRSA", "UTI", "PCP", "Pneumocystis", "Folate"],
    ...
    drugs: [
      {
        ...
        tags: ["Mycobacterium", "Tuberculosis", "Latent TB", "MAC"],
  ...
  },
{
    ...
    drugs: [
      ...
      },
      {
        ...
        summary: "Inhibit ergosterol synthesis. Voriconazole is DOC for Aspergillus. Fluconazole covers Candida. Notorious for CYP3A4 inhibition and teratogenicity",
        tier: 1,
    ...
    drugs: [
      {
        ...
        tags: ["Parasites", "Protozoa", "Malaria", "Plasmodium", "G6PD"],
...
gi: [
{
    ...
    drugs: [
      {
        ...
        tags: ["GERD", "PUD", "Zollinger-Ellison", "H. pylori"],
        ...
        se: "**Long-term use:** hypomagnesemia, C. diff risk, ↑ pneumonia risk, ↓ B12 absorption, osteoporosis (↓ Ca2+ absorption), drug interactions (↓ clopidogrel activation by CYP2C19)",
        ci: "",
  ...
  tags: ["PUD", "NSAID Gastroprotection", "Abortion", "H. pylori"],
  ...
  se: "Loperamide: constipation, ileus, **QT prolongation** at high doses (cardiac Na⁺ channel block at supratherapeutic levels — abuse risk). **Avoid in E. coli O157:H7, C. diff, shigella** (↑ HUS/toxic megacolon risk). Octreotide: cholelithiasis (↓ CCK → biliary stasis), hyperglycemia or hypoglycemia, bradycardia, local injection site reactions",
  ci: "Loperamide: bloody diarrhea, fever, C. diff colitis, infectious diarrhea. Octreotide: caution in diabetes (↓ counter-regulatory hormones)",
...
toxicology: [
  ...
  tags: ["Overdose", "Toxicology", "Reversal", "Antidotes"],
