...
function renderSection(key,subjects,subj,si,sec){
  ...
  // Left side: section title if present, else "Check all" label
  var leftSide=sec.title
    ?'<div class="sub-section-title">'+sec.title+'</div>'
    :'<span class="check-all-lbl">Check all</span>';
  var checkAll='<div class="check-all-bar">'+leftSide
    +'<div class="check-grp">'
    +'<div class="check-col"><span class="check-lbl">Lec</span>'
  ...
  return '<div class="sub-section">'+checkAll+items+'</div>';
}
